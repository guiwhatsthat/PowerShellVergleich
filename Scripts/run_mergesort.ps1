Write-Host "MergeSort PSVersion: "$($PSVersionTable.PSVersion.Major).$($PSVersionTable.PSVersion.Minor)""

# Anpassbare Variablen
$mainFolder = "C:\temp\Result\MergeSort_$($PSVersionTable.PSVersion.Major).$($PSVersionTable.PSVersion.Minor)"
$scriptPath = "C:\scripts\algorithmen\MergeSort.ps1"
$numRuns = 10
