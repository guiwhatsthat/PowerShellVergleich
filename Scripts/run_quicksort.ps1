Write-Host "Quicksort PSVersion: $($PSVersionTable.PSVersion.Major).$($PSVersionTable.PSVersion.Minor)"

# Anpassbare Variablen
$mainFolder = "C:\temp\Result\Quicksort_$($PSVersionTable.PSVersion.Major).$($PSVersionTable.PSVersion.Minor)"
$scriptPath = "C:\scripts\algorithmen\QuickSort.ps1"
$numRuns = 10
...
for ($i = 1; $i -le $numRuns; $i++) {
    ...
    $executionTime = Measure-Command {
        ...
        } while ((Get-Process PowerShell -ErrorAction SilentlyContinue).Count -ge 2)
    }
